...
- Playing with [[https://ziglang.org/][Zig]]:
  #+begin_src emacs-lisp :tangle packages.el
(package! zig-mode)
  #+end_src
* Other tools
...
- [[https://codeberg.org/meow_king/typst-ts-mode/wiki/Installation.md][Typst mode]]:
...
- [[https://github.com/leon-barrett/just-mode.el][just-mode]] for editing [[https://just.systems/][Just]] files.

  #+begin_src emacs-lisp :tangle packages.el
(package! just-mode)
  #+end_src

- [[https://github.com/tuh8888/chezmoi.el][chezmoi.el]] for interacting with [[https://www.chezmoi.io/][chezmoi]].
